...
class TestBEP(unittest.TestCase):
    ...
    def test_get_EoRT(self):
        ...
        self.assertAlmostEqual(self.bep_delta.get_EoRT_act(T=self.T,
                                                           rev=False),
                               exp_EoRT_delta)
        self.assertAlmostEqual(self.bep_delta.get_EoRT_act(T=self.T,
                                                           rev=True),
        ...
        rev_delta_H = self.rxn_delta.get_delta_HoRT(T=self.T,
                                                    rev=True)
        ...
        reactants_H = self.rxn_delta.get_HoRT_state(state='reactants',
                                                    T=self.T)
        ...
        products_H = self.rxn_delta.get_HoRT_state(state='products',
                                                   T=self.T)
