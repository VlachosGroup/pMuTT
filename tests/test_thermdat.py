...
class TestBaseThermo(unittest.TestCase):
	...
	def test_get_a(self):
		np.testing.assert_array_equal(self.Thermdat.get_a(T=self.Thermdat.T_mid-500), self.Thermdat.a_low)
		np.testing.assert_array_equal(self.Thermdat.get_a(T=self.Thermdat.T_mid+500), self.Thermdat.a_high)
		with self.assertWarns(RuntimeWarning):
			np.testing.assert_array_equal(self.Thermdat.get_a(T=self.Thermdat.T_high+100), self.Thermdat.a_high)
		with self.assertWarns(RuntimeWarning):
			np.testing.assert_array_equal(self.Thermdat.get_a(T=self.Thermdat.T_low-100), self.Thermdat.a_low)
	...
	def test_get_CpoR(self):
		...
		np.testing.assert_almost_equal(self.Thermdat.get_CpoR(Ts=Ts[0]), CpoR_expected[0])
		np.testing.assert_array_almost_equal(self.Thermdat.get_CpoR(Ts=Ts), CpoR_expected)
	...
	def test_get_HoRT(self):
		...
		np.testing.assert_almost_equal(self.Thermdat.get_HoRT(Ts=Ts[0]), HoRT_expected[0])
		np.testing.assert_array_almost_equal(self.Thermdat.get_HoRT(Ts=Ts), HoRT_expected)
	...
	def test_get_SoR(self):
		...
		np.testing.assert_almost_equal(self.Thermdat.get_SoR(Ts=Ts[0]), SoR_expected[0])
		np.testing.assert_array_almost_equal(self.Thermdat.get_SoR(Ts=Ts), SoR_expected)
	...
	def test_get_GoRT(self):
		...
		np.testing.assert_almost_equal(self.Thermdat.get_GoRT(Ts=Ts[0]), GoRT_expected[0])
		np.testing.assert_array_almost_equal(self.Thermdat.get_GoRT(Ts=Ts), GoRT_expected)
