...
class TestNasa(unittest.TestCase):
    ...
    def test_get_CpoR(self):
        ...
        np.testing.assert_almost_equal(self.Nasa_direct.get_CpoR(Ts=Ts[0]), CpoR_expected[0])
        np.testing.assert_array_almost_equal(self.Nasa_direct.get_CpoR(Ts=Ts), CpoR_expected)
    ...
    def test_get_HoRT(self):
        ...
        np.testing.assert_almost_equal(self.Nasa_direct.get_HoRT(Ts=Ts[0]), HoRT_expected[0])
        np.testing.assert_array_almost_equal(self.Nasa_direct.get_HoRT(Ts=Ts), HoRT_expected)
    ...
    def test_get_SoR(self):
        ...
        np.testing.assert_almost_equal(self.Nasa_direct.get_SoR(Ts=Ts[0]), SoR_expected[0])
        np.testing.assert_array_almost_equal(self.Nasa_direct.get_SoR(Ts=Ts), SoR_expected)
