...
Vlachos group code for Hindered translator/hindered rotor model.
...
class HinderedThermo:
	...
	Attributes
		model (ase.thermochemistry.HinderedThermo object): The Hindered Thermo object has the following attributes.
			vib_energies ((3N,) ndarray): Vibrational energies in eV. N is the number of atoms.
			...
			rotationalminima (int):	Number of equivalent minima for an adsorbate full rotation
				e.g. 6 for an adsorbate on an fcc(111) top site
			potentialenergy (float): Potential energy in eV
			atoms (ase.Atoms object): Used to calculate mass and inertia
			symmetrynumber (int): Symmetry number of adsorbate. 
