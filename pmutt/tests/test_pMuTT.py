...
class Testpmutt(unittest.TestCase):
    ...
    def test_force_pass_arguments(self):
        self.assertEqual(
            pmutt._force_pass_arguments(self.sum_fn, **{'num1': 1, 'num2': 2}),
            3)
    ...
    def test_get_mode_quantity(self):
        ...
        self.assertEqual(pmutt._get_mode_quantity(mode=sum_obj,
    ...
    def test_pmutt_list_to_dict(self):
        ...
        self.assertDictEqual(pmutt.pmutt_list_to_dict([sum_obj1, sum_obj2],
                                                      key='num1'),
                             {1: sum_obj1, 2:sum_obj2})
    ...
    def test_get_R_adj(self):
        elements = {'H': 2}
        self.assertAlmostEqual(pmutt._get_R_adj(units='J/g/K',
                                                elements=elements),
                               self.ans.at['test_get_R_adj', 0])
        self.assertAlmostEqual(pmutt._get_R_adj(units='J/mol/K',
                                                elements=elements),
...
class Test_pmuttBase(unittest.TestCase):
    ...
    def test_to_dict(self):
        ...
        self.assertDictEqual(self.pmutt_base.to_dict(),
                             out_dict)

    def test_from_dict(self):
        in_dict = {'class': "<class 'pmutt._pmuttBase'>"}
        self.assertEqual(self.pmutt_base,
                         pmutt._pmuttBase.from_dict(in_dict))
