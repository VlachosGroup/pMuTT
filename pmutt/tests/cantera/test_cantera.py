...
class TestCantera(unittest.TestCase):
    ...
    def test_get_range_CTI(self):
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs),
                         CTI_range_out)
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs_id),
                         CTI_range_out)
        ...
        self.assertEqual(cantera._get_range_CTI(objs=objs_name),
                         CTI_range_out)

        # Test that CTI range handles strings that have a header and a footer
        objs = ['test_0001', 'test_0002', 'test_0003', 'test_0005', 'test_0008',
                'test_0009', 'test_0010']
        ...
        objs = ['test1_0001', 'test1_0002', 'test1_0003', 'test1_0005',
