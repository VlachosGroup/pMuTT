...
the dictionary, ``pMuTT.statmech.presets``. The same H2O StatMech object can be specified without
...
+==================+=========================================+
| trans_model      | pMuTT.statmech.trans.IdealTrans         |
+------------------+-----------------------------------------+
| n_degrees        | 3                                       |
+------------------+-----------------------------------------+
| vib_model        | pMuTT.statmech.vib.HarmonicVib          |
+------------------+-----------------------------------------+
| elec_model       | pMuTT.statmech.elec.IdealElec           |
+------------------+-----------------------------------------+
| rot_model        | pMuTT.statmech.rot.RigidRotor           |
+------------------+-----------------------------------------+
...
| Parameter   | Default Value                           |
+=============+=========================================+
| trans_model | pMuTT.statmech.EmptyMode                |
+-------------+-----------------------------------------+
| vib_model   | pMuTT.statmech.EmptyMode                |
+-------------+-----------------------------------------+
| rot_model   | pMuTT.statmech.EmptyMode                |
+-------------+-----------------------------------------+
| elec_model  | pMuTT.statmech.EmptyMode                |
+-------------+-----------------------------------------+
| nucl_model  | pMuTT.statmech.EmptyMode                |
+-------------+-----------------------------------------+
...
============================
If you would like to create your own class to be stored by :class:`~pMuTT.statmech.StatMech`, it should have the methods: 
