...
pMuTT instructions
------------------
1. `Install Anaconda with Python 3.7`_.
2. Install pMuTT using the `installation instructions`_.
3. Download `the exercise files`_.
...
.. _`pMuTT issues page`: https://github.com/VlachosGroup/pMuTT/issues?utf8=%E2%9C%93&q=is%3Aissue+tag%3Anam2019
...
.. _`the exercise files`: https://www.dropbox.com/s/u5ef2onhrepad1d/pmutt_nam2019.zip?dl=1
.. _`open it`: https://jupyter-notebook-beginner-guide.readthedocs.io/en/latest/execute.html
.. _`Install VirtualBox`: https://www.virtualbox.org/
